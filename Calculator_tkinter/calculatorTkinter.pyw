...
inmultire = Button(frame_button, text='*', fg='black', width=15, height=3, bd=1, bg='#eee', cursor='hand2',
...
scadere = Button(frame_button, text='-', fg='black', width=15, height=3, bd=1, bg='#eee', cursor='hand2',
...
adunare = Button(frame_button, text='+', fg='black', width=15, height=3, bd=1, bg='#eee', cursor='hand2',
